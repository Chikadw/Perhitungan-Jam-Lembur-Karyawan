...
if($pro=="simpan"){
	...
	if($ada>0){
	echo"<script>gagal('penugasan_detail&id=$id_penugasan','Gagal Simpan');</script>";
	}	
else{	
...
$simpan=process($conn,$sql);
	...
	if($simpan === TRUE) {
	echo"<script>berhasil('penugasan_detail&id=$id_penugasan','Data Sebanyak $total Sukses Simpan');</script>";
	}
		else{
			echo"<script>gagal('penugasan_detail&id=$id_penugasan','Gagal Simpan');</script>";
			}
	...
	if($simpan === TRUE) {
	echo"<script>berhasil('penugasan_detail&id=$id_penugasan','Data Sebanyak $total Sukses Ubah');</script>";
	
	}
		else{
			echo"<script>gagal('penugasan_detail&id=$id_penugasan','Gagal Ubah');</script>";}
